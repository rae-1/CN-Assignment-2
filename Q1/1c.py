...
def run():
    ...
    ## modification in network paths to obtain required route
    info(net[ 'ra' ].cmd("ip route change 192.168.3.0/24 via 192.100.0.2 dev r1-eth2"))
    info(net[ 'rc' ].cmd("ip route change 192.168.1.0/24 via 192.100.1.2 dev r3-eth2"))
